# Orchestra decision docs

Human-maintained pointers for **`skills/orchestra-decision`**. Agents use this folder **only when it exists** (Phase 2 shortlist in that skill).
