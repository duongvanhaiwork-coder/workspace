...
**REQUIRES:** **`verification-before-completion`** — fresh run even if Verify/Regression already logged in `l3-02` / `l4-04`. Do not skip because an earlier phase passed.
...
- **Fix:** Only clean up worktrees under `.worktrees/` or `worktrees/` (not host-native / harness workspaces)
