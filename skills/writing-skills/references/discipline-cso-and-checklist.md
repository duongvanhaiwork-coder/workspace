# Discipline, CSO, and skill creation checklist

Deep reference moved from `SKILL.md` (2026-05-29). Load when authoring or pressure-testing skills.
...
- ✅ Good: `**REQUIRES:** \`test-driven-development\``
...
**Visualizing for your human partner:** Use the `render-graphs` helper under this skill’s `scripts/` directory to render a skill’s flowcharts to SVG (see that file’s header for per-diagram vs combined output).
...
**IMPORTANT: Use task-tracker (map per `superpowers/references/`) for EACH checklist item below.**
